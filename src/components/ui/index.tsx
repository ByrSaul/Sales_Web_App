...
export const Badge: React.FC<BadgeProps> = ({
  ...
  <span
    className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-semibold ${BADGE_STYLES[variant]} ${className}`}
  >
    ...
    <div className="fixed inset-0 z-50 flex items-end md:items-center md:justify-center">
      ...
      <div className="relative w-full md:max-w-lg bg-white rounded-t-2xl md:rounded-2xl shadow-2xl max-h-[85vh] flex flex-col">
        <div className="flex items-center justify-between p-4 border-b border-outline-variant/40">
          ...
          <button
            onClick={onClose}
            className="w-7 h-7 flex items-center justify-center rounded-full hover:bg-surface-container"
          >
...
export const InfoRow: React.FC<InfoRowProps> = ({ label, value, icon, className = '' }) => (
  <div
    className={`flex items-center gap-2 py-2 border-b border-outline-variant/30 last:border-0 ${className}`}
  >
